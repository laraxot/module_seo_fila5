...
1. Pest: `cd laravel && ./vendor/bin/pest laravel/Modules/Seo/tests`
2. PHPStan: `cd laravel && ./vendor/bin/phpstan analyse laravel/Modules/Seo/tests --level=5`
3. PHPMD: `phpmd laravel/Modules/Seo/tests text phpmd.xml`
